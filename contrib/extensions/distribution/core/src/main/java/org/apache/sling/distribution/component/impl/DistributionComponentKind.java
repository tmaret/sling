    ...
    AGENT("agent", AGENT_RESOURCE_TYPE, AGENT_LIST_RESOURCE_TYPE, DistributionAgent.class, new HashMap<String, String>() {
        {
            ...
            put("pub", "com.adobe.granite.distribution.pipeline.impl.agent.PublisherFactory");
            put("sub", "com.adobe.granite.distribution.pipeline.impl.agent.SubscriberFactory");
        }
    }),
